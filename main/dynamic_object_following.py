...
def real_time_trajectory_generation(dobot, dmp, predicted_arm_pos_queue):
...
if __name__ == "__main__":
    ...
    dmp_thread = threading.Thread(target=real_time_trajectory_generation, args=(dobot, dmp, predicted_arm_pos_queue))
    dmp_thread.start()
